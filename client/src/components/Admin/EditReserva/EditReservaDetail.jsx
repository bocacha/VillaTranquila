    ...
    <div>
      <div className={styles.container}>
        <div className={styles.infoContainer}>
          <label>Datos de reservas originales</label>
          <table>
            <tbody>
              <tr>
        ...
        {!Nuevo.Cancelar ? (
          ...
          <div className={styles.infoContainer}>
            <img src={cancelar} alt="Imagen no encontrada" className={styles.img1}></img>
          </div>
        )}
      </div>
