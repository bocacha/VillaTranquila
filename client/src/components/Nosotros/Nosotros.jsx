    ...
    return (
        <div className={styles.nosotros}>
            ...
            <ul className={styles.container}>
                ...
                <li className={styles.card}>
                    <div>
                        <h2 className={styles.info}>Martin E. Gonzalez</h2>
                ...
                <li className={styles.card}>
                    <div>
                        <h2 className={styles.info}>Ignacio Giorgis</h2>
                ...
                <li className={styles.card}>
                    <div>
                        <h2 className={styles.info}>Karenina Kauffmann</h2>
                ...
                <li className={styles.card}>
                    <div>
                        <h2 className={styles.info}>Javier Ardiles Reibel</h2>
