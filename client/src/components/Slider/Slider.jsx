    ...
    <React.Fragment>
      ...
      <Carousel variant="dark" className={styles.container}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <Link className={styles.link} to="/reserva"><div className={styles.wrapper}><h3 className={styles.newsletter}>Suscríbase al Newsletter</h3></div></Link>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <Link className={styles.link} to="/reserva"><div className={styles.wrapper}><h3 className={styles.chatea}>Chateá con nosotros</h3></div></Link>
          </Carousel.Caption>
        </Carousel.Item>
        {/* Quinto Slide */}
        <Carousel.Item>
