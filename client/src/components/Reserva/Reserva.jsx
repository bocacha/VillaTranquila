...
function validate(filters) {
  ...
  if (
    parseInt(filters.priceMin) > parseInt(filters.priceMax) &&
    filters.priceMin !== "all" &&
...
export default function Reserva() {
  ...
  let orderedCabins = currentCabins?.sort((a, b) =>
    ...
    <div>
      ...
      <div className={styles.filtrosContainer}>
        <ul className={styles.reserva}>
          <li>
            <button className={styles.reload} onClick={(e) => handleReload(e)}>
              Limpiar filtros{" "}
              <p>
                <AiOutlineReload />
              </p>
          ...
          <li>
            <hr />
            <label className={styles.serviceTitle}>
              <p>
                <MdRoomService />
              </p>{" "}
              Que cuente con:
      ...
      <div className={styles.cabinPage}>
        ...
        <div className={styles.paginado}>
          <Paginado
            cabinsPerPage={cabinsPerPage}
            allCabins={allCabins.length}
            paginado={paginado}
          />
        </div>
      </div>
