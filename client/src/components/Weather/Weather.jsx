    ...
    <div className={styles.weather}>
      ...
      <div className={styles.container}>
        {weather?.map((e) => {
          ...
          if (
            e.text === "Patchy rain possible" ||
            e.text === "Patchy sleet possible"
          ) {
            icono = (
            ...
            e.text === "Patchy snow possible" ||
            e.text === "Patchy heavy snow" ||
            e.text === "Patchy light snow" ||
            e.text === "Light snow showers"
          ) {
            icono = (
              <div className={styles.wcont}>
            ...
            e.text === "Moderate snow" ||
            e.text === "Moderate or heavy snow showers" ||
            e.text === "Light snow"
          ) {
            icono = (
              <div className={styles.wcont}>
